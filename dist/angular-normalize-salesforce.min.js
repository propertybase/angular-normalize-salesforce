...
"use strict";angular.module("angular-normalize-salesforce").constant("ansSalesforceStandardFields",["id","isdeleted","name","createddate","createdbyid","lastmodifieddate","lastmodifiedbyid","systemmodstamp","lastactivitydate","currencyisocode"]);
...
"use strict";var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}};angular.module("angular-normalize-salesforce").factory("normalizeSalesforce",["ansSalesforceSObjects","ansSalesforceStandardObjects","ansSalesforceStandardFields",function(ansSalesforceSObjects,ansSalesforceStandardObjects,ansSalesforceStandardFields){var NormalizeSalesforce;return new(NormalizeSalesforce=function(){function NormalizeSalesforce(){this._denormalizeObject=__bind(this._denormalizeObject,this),this._denormalizeArray=__bind(this._denormalizeArray,this),this._denormalizeString=__bind(this._denormalizeString,this),this._normalizeObject=__bind(this._normalizeObject,this),this._normalizeArray=__bind(this._normalizeArray,this),this.denormalizeObjectName=__bind(this.denormalizeObjectName,this),this.denormalize=__bind(this.denormalize,this),this.normalize=__bind(this.normalize,this),this.standardFields=ansSalesforceStandardFields,this.standardObjects=ansSalesforceStandardObjects,this.sObjectFields=ansSalesforceSObjects}return NormalizeSalesforce.prototype.normalize=function(part,blacklist,currentPath){var type_name;if(null==blacklist&&(blacklist=[]),null==currentPath&&(currentPath=""),type_name=Object.prototype.toString.call(part),_(blacklist).contains(part)||_(blacklist).contains(currentPath))return part;switch(!1){case!_(part).isString():return this._normalizeString(part);case!_(part).isArray():return this._normalizeArray(part,blacklist);case!_(part).isObject():return this._normalizeObject(part,blacklist,currentPath);default:throw new Error("Type "+type_name+" not supported. Only String, Array and Object are supported.")}},NormalizeSalesforce.prototype.denormalize=function(part,sObject){var type_name;switch(type_name=Object.prototype.toString.call(part),!1){case!_(part).isString():return this._denormalizeString(part,sObject);case!_(part).isArray():return this._denormalizeArray(part,sObject);case!_(part).isObject():return this._denormalizeObject(part,sObject);default:throw new Error("Type "+type_name+" not supported. Only String, Array and Object are supported.")}},NormalizeSalesforce.prototype.denormalizeObjectName=function(name){return this._denormalize(name,this.standardObjects)},NormalizeSalesforce.prototype._normalizeString=function(string){return string.toLowerCase().replace(/__c$/,"")},NormalizeSalesforce.prototype._normalizeArray=function(array,blacklist){return _.map(array,function(_this){return function(element){return _this.normalize(element,blacklist)}}(this))},NormalizeSalesforce.prototype._normalizeObject=function(object,blacklist,currentPath){var normalized;return normalized={},_(object).forEach(function(_this){return function(value,key){var nextPath;return _(value).isObject()&&!_(value).isFunction()?(nextPath=_.compact([currentPath].concat([key])).join("."),normalized[_this.normalize(key,blacklist)]=_this.normalize(value,blacklist,nextPath)):normalized[_this.normalize(key,blacklist)]=value,!0}}(this)),normalized},NormalizeSalesforce.prototype._denormalize=function(part,avoidList){return _(avoidList).contains(part)?part:""+part+"__c"},NormalizeSalesforce.prototype._denormalizeString=function(string,sObject){var standardFields;return sObject=this.normalize(sObject),standardFields=this.standardFields,_(this.sObjectFields).has(sObject)&&(standardFields=_.uniq(standardFields.concat(this.sObjectFields[sObject]))),this._denormalize(string,standardFields)},NormalizeSalesforce.prototype._denormalizeArray=function(array,sObject){return _.map(array,function(_this){return function(element){return _this.denormalize(element,sObject)}}(this))},NormalizeSalesforce.prototype._denormalizeObject=function(object,sObject){var denormalized;return denormalized={},_(object).forEach(function(_this){return function(value,key){return denormalized[_this.denormalize(key,sObject)]=_(value).isObject()&&!_(value).isFunction()?_this.denormalize(value,sObject):value,!0}}(this)),denormalized},NormalizeSalesforce}())}]);
